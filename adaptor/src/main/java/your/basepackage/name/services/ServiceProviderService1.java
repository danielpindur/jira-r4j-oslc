...
import your.basepackage.name.RestDelegate;
import your.basepackage.name.ServerConstants;
...
// End of user code
@OslcService(JiraDomainConstants.JIRA_NAMSPACE)
@Path("service1/projects")
public class ServiceProviderService1
{
    ...
    (
        ...
        resourceShape = OslcConstants.PATH_RESOURCE_SHAPES + "/" + JiraDomainConstants.PROJECT_PATH,
        resourceTypes = {JiraDomainConstants.PROJECT_TYPE},
        usages = {}
    )
    @GET
    @Path("query")
    ...
    @Operation(
        summary = "Query capability for resources of type {" + JiraDomainConstants.PROJECT_LOCALNAME + "}",
        description = "Query capability for resources of type {" + "<a href=\"" + JiraDomainConstants.PROJECT_TYPE + "\">" + JiraDomainConstants.PROJECT_LOCALNAME + "</a>" + "}" +
    ...
    public void queryProjectsAsHtml(
                                       ...
                                       @QueryParam("oslc.pageSize") final String pageSizeString) throws ServletException, IOException
    {
        ...
        if ((OSLC4JUtils.hasLyoStorePagingPreciseLimit() && resources.size() >= pageSize) 
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/your/basepackage/name/projectscollection.jsp");
    ...
    @OslcCreationFactory
    (
         title = "Project Creation Factory",
         label = "CreationFactory1",
         resourceShapes = {OslcConstants.PATH_RESOURCE_SHAPES + "/" + JiraDomainConstants.PROJECT_PATH},
         resourceTypes = {JiraDomainConstants.PROJECT_TYPE},
         usages = {}
    )
    @POST
    ...
    @Produces({OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_JSON_LD, OslcMediaType.TEXT_TURTLE, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON})
    @Operation(
        summary = "Creation factory for resources of type {" + JiraDomainConstants.PROJECT_LOCALNAME + "}",
        description = "Creation factory for resources of type {" + "<a href=\"" + JiraDomainConstants.PROJECT_TYPE + "\">" + JiraDomainConstants.PROJECT_LOCALNAME + "</a>" + "}" +
            ", with respective resource shapes {" + "<a href=\"" + "../services/" + OslcConstants.PATH_RESOURCE_SHAPES + "/" + JiraDomainConstants.PROJECT_PATH + "\">" + JiraDomainConstants.PROJECT_LOCALNAME + "</a>" + "}",
        responses = { 
