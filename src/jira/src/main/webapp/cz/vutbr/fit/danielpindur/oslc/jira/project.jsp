...
<div class="container">
    <div class="page-header">
        ...
        <%
        URI shapeUri = UriBuilder.fromUri(OSLC4JUtils.getServletURI()).path(OslcConstants.PATH_RESOURCE_SHAPES).path(JiraDomainConstants.PROJECT_PATH).build();
        Collection<URI> types = aProject.getTypes();   
        %>
        <p class="lead">Resource URI:&nbsp;
        <jsp:include page="/cz/vutbr/fit/danielpindur/oslc/jira/projecttohtml.jsp"></jsp:include>
        </p>
        <p class="lead">Shape:&nbsp;
