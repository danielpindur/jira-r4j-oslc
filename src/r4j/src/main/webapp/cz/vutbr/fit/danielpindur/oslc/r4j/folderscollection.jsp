...
<%
  List<Folder> resources = (List<Folder>) request.getAttribute("resources");
...
<head>
  ...
  <title>Query capability QueryFolder</title>
...
<!-- Fixed navbar -->
  ...
  <div class="container">
    <div class="page-header">
      <h1>Query Capability &quot;QueryFolder&quot; results</h1>
      <div class="alert alert-secondary" role="alert">
        ...
        <% for (Folder aResource : resources) { %>
