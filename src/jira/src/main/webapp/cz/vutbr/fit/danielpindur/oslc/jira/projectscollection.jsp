...
<%
  List<Project> resources = (List<Project>) request.getAttribute("resources");
...
<head>
  ...
  <title>Query capability QueryProject</title>
...
<!-- Fixed navbar -->
  ...
  <div class="container">
    <div class="page-header">
      <h1>Query Capability &quot;QueryProject&quot; results</h1>
      <div class="alert alert-secondary" role="alert">
        ...
        <% for (Project aResource : resources) { %>
