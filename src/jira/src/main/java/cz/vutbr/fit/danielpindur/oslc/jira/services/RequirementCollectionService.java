...
public class RequirementCollectionService
{
        ...
        ) throws IOException, ServletException, URISyntaxException
    {
        ...
        final RequirementCollection aRequirementCollection = delegate.getRequirementCollection(httpServletRequest, id);
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aRequirementCollection != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/danielpindur/oslc/jira/requirementcollection.jsp");
    ...
    @GET
    @Path("RequirementCollection/{id}/smallPreview")
    @Produces({ MediaType.TEXT_HTML })
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aRequirementCollection != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/danielpindur/oslc/jira/requirementcollectionsmallpreview.jsp");
            httpServletResponse.addHeader(ServerConstants.HDR_OSLC_VERSION, ServerConstants.OSLC_VERSION_V2);
            addCORSHeaders(httpServletResponse);
            rd.forward(httpServletRequest, httpServletResponse);
            return;
    ...
    @GET
    @Path("RequirementCollection/{id}/largePreview")
    @Produces({ MediaType.TEXT_HTML })
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aRequirementCollection != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/danielpindur/oslc/jira/requirementcollectionlargepreview.jsp");
            httpServletResponse.addHeader(ServerConstants.HDR_OSLC_VERSION, ServerConstants.OSLC_VERSION_V2);
            addCORSHeaders(httpServletResponse);
            rd.forward(httpServletRequest, httpServletResponse);
            return;
        ...
        ) throws IOException, ServletException, URISyntaxException
    {
        ...
        // End of user code
        return errorHandler.Execute("Delete Requirement Collection", () -> {
            final RequirementCollection aResource = delegate.getRequirementCollection(httpServletRequest, id);

            if (aResource != null) {
                // Start of user code deleteRequirementCollection
                // End of user code
                boolean deleted = delegate.deleteRequirementCollection(httpServletRequest, id);
                if (deleted)
        ...
        ) throws IOException, ServletException
    {
        ...
        // End of user code
        return errorHandler.Execute("Update Requirement Collection", () -> {
            final RequirementCollection originalResource = delegate.getRequirementCollection(httpServletRequest, id);
            ...
            if (originalResource != null) {
                ...
                if ((eTagHeader == null) || (originalETag.equals(eTagHeader))) {
                    ...
                    // End of user code
                    final RequirementCollection updatedResource = delegate.updateRequirementCollection(httpServletRequest, aResource, id);
