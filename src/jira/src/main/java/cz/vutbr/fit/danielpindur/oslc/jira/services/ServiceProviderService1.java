...
// End of user code
@OslcService(Oslc_rmDomainConstants.OSLC_REQUIREMENTS_MANAGEMENT_NAMSPACE)
...
public class ServiceProviderService1
{
    ...
    @OslcQueryCapability
    (
        title = "QueryRequirement",
        label = "QueryRequirement",
                                       ...
                                       @QueryParam("oslc.pageSize") final String pageSizeString) throws ServletException, IOException
    {
        ...
        if ((OSLC4JUtils.hasLyoStorePagingPreciseLimit() && resources.size() >= pageSize) 
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/danielpindur/oslc/jira/requirementscollection.jsp");
    ...
    @OslcQueryCapability
    (
        title = "QueryRequirementCollection",
        label = "QueryRequirementCollection",
    ...
    @GET
    @Path("queryRequirementCollection")
    @Produces({OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_JSON_LD, OslcMediaType.TEXT_TURTLE, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON})
    @Operation(
                                       ...
                                       @QueryParam("oslc.pageSize") final String pageSizeString) throws ServletException, IOException
    {
        ...
        if ((OSLC4JUtils.hasLyoStorePagingPreciseLimit() && resources.size() >= pageSize) 
            ...
            httpServletRequest.setAttribute("resources", resources);
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/danielpindur/oslc/jira/requirementcollectionscollection.jsp");
            rd.forward(httpServletRequest,httpServletResponse);
            return;
        }
        throw new WebApplicationException(Status.NOT_FOUND);
    ...
    @OslcDialog
    (
         title = "SelectorRequirement",
         label = "SelectorRequirement",
         uri = "service1/resources/selectorRequirement",
         hintWidth = "250px",
         hintHeight = "250px",
         resourceTypes = {Oslc_rmDomainConstants.REQUIREMENT_TYPE},
         usages = {}
        ...
        ) throws ServletException, IOException, JSONException
    {
        ...
        if (terms != null ) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/danielpindur/oslc/jira/requirementselector.jsp");
            rd.forward(httpServletRequest, httpServletResponse);
            return null;
        }
    }
    ...
    @OslcDialog
    (
         title = "SelectorRequirementCollection",
         label = "SelectorRequirementCollection",
         uri = "service1/resources/selectorRequirementCollection",
         hintWidth = "250px",
         hintHeight = "250px",
         resourceTypes = {Oslc_rmDomainConstants.REQUIREMENTCOLLECTION_TYPE},
         usages = {}
    ...
    @GET
    @Path("selectorRequirementCollection")
    @Consumes({ MediaType.TEXT_HTML, MediaType.WILDCARD })
        ...
        ) throws ServletException, IOException, JSONException
    {
        ...
        if (terms != null ) {
            httpServletRequest.setAttribute("terms", terms);
            final List<RequirementCollection> resources = delegate.RequirementCollectionSelector(httpServletRequest, terms);
            if (resources!= null) {
                JSONArray resourceArray = new JSONArray();
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/danielpindur/oslc/jira/requirementcollectionselector.jsp");
            rd.forward(httpServletRequest, httpServletResponse);
            return null;
        }
    }
        ...
        ) throws IOException, ServletException
    {
        ...
        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/danielpindur/oslc/jira/requirementcreator.jsp");
        rd.forward(httpServletRequest, httpServletResponse);
        return null;
    }
    ...
    @OslcDialog
    (
         title = "CreatorRequirement",
         label = "CreatorRequirement",
         uri = "service1/resources/creatorRequirement",
         hintWidth = "250px",
         hintHeight = "250px",
         resourceTypes = {Oslc_rmDomainConstants.REQUIREMENT_TYPE},
         usages = {}
    ...
    public void createRequirementFromDialog(MultivaluedMap<String, String> formParams
        ...
        paramValues = formParams.get("project");
        if (paramValues != null) {
                if (paramValues.size() == 1) {
                    if (paramValues.get(0).length() != 0)
                        aResource.setProject(new Link(new URI(paramValues.get(0))));
                    // else, there is an empty value for that parameter, and hence ignore since the parameter is not actually set.
                }
     ...
     */
    @GET
    @Path("creatorRequirementCollection")
    @Consumes({MediaType.WILDCARD})
    public Response RequirementCollectionCreator(
                
        ) throws IOException, ServletException
    {
        // Start of user code RequirementCollectionCreator
        // End of user code

        httpServletRequest.setAttribute("creatorUri", UriBuilder.fromUri(OSLC4JUtils.getServletURI()).path(uriInfo.getPath()).build().toString());

        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/danielpindur/oslc/jira/requirementcollectioncreator.jsp");
        rd.forward(httpServletRequest, httpServletResponse);
        return null;
    }
    ...
    @OslcDialog
    (
         title = "CreatorRequirementCollection",
         label = "CreatorRequirementCollection",
         uri = "service1/resources/creatorRequirementCollection",
         hintWidth = "250px",
         hintHeight = "250px",
         resourceTypes = {Oslc_rmDomainConstants.REQUIREMENTCOLLECTION_TYPE},
         usages = {}
    ...
    @Path("creatorRequirementCollection")
    @Consumes({ MediaType.APPLICATION_FORM_URLENCODED})
    public void createRequirementCollectionFromDialog(MultivaluedMap<String, String> formParams
            
        ) throws URISyntaxException, ParseException {
        RequirementCollection newResource = null;

        RequirementCollection aResource = new RequirementCollection();
