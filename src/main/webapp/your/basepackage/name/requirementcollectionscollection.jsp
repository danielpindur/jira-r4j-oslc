...
<%
  List<RequirementCollection> resources = (List<RequirementCollection>) request.getAttribute("resources");
...
<head>
  ...
  <title>Query capability Requirement Collection Query</title>
...
<!-- Fixed navbar -->
  ...
  <div class="container">
    <div class="page-header">
      <h1>Query Capability &quot;Requirement Collection Query&quot; results</h1>
      <div class="alert alert-secondary" role="alert">
        ...
        <% for (RequirementCollection aResource : resources) { %>
