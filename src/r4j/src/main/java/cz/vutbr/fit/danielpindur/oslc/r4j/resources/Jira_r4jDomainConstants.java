...
public interface Jira_r4jDomainConstants
{
    ...
    public static String JIRA_R4J_DOMAIN = "http://fit.vutbr.cz/group/verifit/oslc/ns/jira_r4j#";
    public static String JIRA_R4J_DOMAIN_NAME = "JIRA R4J";
    public static String JIRA_R4J_NAMSPACE = "http://fit.vutbr.cz/group/verifit/oslc/ns/jira_r4j#"; //Vocabulary namespace for the resources and resource properties, when no explicit vocabulary (describes, or propertyDefinition) is defined 
