...
public class PersonService
{
    ...
    @Operation(
        ...
        description = "GET for resources of type {'" + "<a href=\"" + FoafDomainConstants.PERSON_TYPE + "\">" + FoafDomainConstants.PERSON_LOCALNAME + "</a>" + "'}" +
        ...
        ) throws IOException, ServletException, URISyntaxException
    {
        ...
        if (aPerson != null) {
            ...
            // End of user code
            httpServletResponse.setHeader("ETag", delegate.getETagFromPerson(aPerson));
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aPerson != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/danielpindur/oslc/jira/person.jsp");
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aPerson != null) {
            ...
            largePreview.setDocument(UriBuilder.fromUri(aPerson.getAbout()).path("largePreview").build());
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aPerson != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/danielpindur/oslc/jira/personsmallpreview.jsp");
            httpServletResponse.addHeader(ServerConstants.HDR_OSLC_VERSION, ServerConstants.OSLC_VERSION_V2);
            addCORSHeaders(httpServletResponse);
            rd.forward(httpServletRequest, httpServletResponse);
            return;
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aPerson != null) {
            httpServletRequest.setAttribute("aPerson", aPerson);
            // Start of user code getPersonAsHtmlLargePreview_setAttributes
            // End of user code

            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/danielpindur/oslc/jira/personlargepreview.jsp");
            httpServletResponse.addHeader(ServerConstants.HDR_OSLC_VERSION, ServerConstants.OSLC_VERSION_V2);
            addCORSHeaders(httpServletResponse);
            rd.forward(httpServletRequest, httpServletResponse);
            return;
