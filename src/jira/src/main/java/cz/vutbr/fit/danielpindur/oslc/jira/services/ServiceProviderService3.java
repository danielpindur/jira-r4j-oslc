...
public class ServiceProviderService3
{
                                       ...
                                       @QueryParam("oslc.pageSize") final String pageSizeString) throws ServletException, IOException
    {
        ...
        if ((OSLC4JUtils.hasLyoStorePagingPreciseLimit() && resources.size() >= pageSize) 
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/danielpindur/oslc/jira/projectscollection.jsp");
    ...
    @OslcDialog
    (
         title = "SelectorProject",
         label = "SelectorProject",
         uri = "service3/projects/selectorProject",
         hintWidth = "250px",
         hintHeight = "250px",
         resourceTypes = {JiraDomainConstants.PROJECT_TYPE},
         usages = {}
        ...
        ) throws ServletException, IOException, JSONException
    {
        ...
        if (terms != null ) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/danielpindur/oslc/jira/projectselector.jsp");
            rd.forward(httpServletRequest, httpServletResponse);
            return null;
        }
    }
