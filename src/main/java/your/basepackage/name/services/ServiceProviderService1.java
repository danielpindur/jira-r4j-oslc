...
public class ServiceProviderService1
{
                                       ...
                                       @QueryParam("oslc.pageSize") final String pageSizeString) throws ServletException, IOException
    {
        ...
        if ((OSLC4JUtils.hasLyoStorePagingPreciseLimit() && resources.size() >= pageSize) 
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/your/basepackage/name/requirementscollection.jsp");
    ...
    @OslcQueryCapability
    (
        title = "Requirement Collection Query",
                                       ...
                                       @QueryParam("oslc.pageSize") final String pageSizeString) throws ServletException, IOException
    {
        ...
        if ((OSLC4JUtils.hasLyoStorePagingPreciseLimit() && resources.size() >= pageSize) 
            ...
            httpServletRequest.setAttribute("resources", resources);
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/your/basepackage/name/requirementcollectionscollection.jsp");
            rd.forward(httpServletRequest,httpServletResponse);
            return;
        }
        throw new WebApplicationException(Status.NOT_FOUND);
        ...
        ) throws IOException, ServletException
    {
        ...
        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/your/basepackage/name/requirementcollectioncreator.jsp");
        rd.forward(httpServletRequest, httpServletResponse);
        return null;
    }
    ...
    @OslcDialog
    (
         title = "Requirement Collection Creation Factory",
         label = "CreationDialog1",
         uri = "resources/creator",
         hintWidth = "250px",
         hintHeight = "250px",
         resourceTypes = {Oslc_rmDomainConstants.REQUIREMENTCOLLECTION_TYPE},
         usages = {}
    ...
    public void createRequirementCollectionFromDialog(MultivaluedMap<String, String> formParams
        ...
        if (paramValues != null) {
                if (paramValues.size() == 1) {
                    if (paramValues.get(0).length() != 0)
                        aResource.setDecomposes(new Link(new URI(paramValues.get(0))));
                    // else, there is an empty value for that parameter, and hence ignore since the parameter is not actually set.
                }
