...
<%@page import="your.basepackage.name.resources.Person"%>
<%@ page contentType="text/html" language="java" pageEncoding="UTF-8" %>
<%
  List<Person> resources = (List<Person>) request.getAttribute("resources");
...
<head>
  ...
  <title>Query capability Person Query</title>
...
<!-- Fixed navbar -->
  ...
  <div class="container">
    <div class="page-header">
      <h1>Query Capability &quot;Person Query&quot; results</h1>
      <div class="alert alert-secondary" role="alert">
        ...
        <% for (Person aResource : resources) { %>
