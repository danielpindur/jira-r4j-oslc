...
// End of user code
@OslcService(FoafDomainConstants.FOAF_NAMSPACE)
@Path("service2/persons")
public class ServiceProviderService2
{
    ...
    (
        title = "QueryPerson",
        label = "QueryPerson",
        resourceShape = OslcConstants.PATH_RESOURCE_SHAPES + "/" + FoafDomainConstants.PERSON_PATH,
        resourceTypes = {FoafDomainConstants.PERSON_TYPE},
        usages = {}
    )
    @GET
    @Path("queryPerson")
    ...
    @Operation(
        summary = "Query capability for resources of type {" + FoafDomainConstants.PERSON_LOCALNAME + "}",
        description = "Query capability for resources of type {" + "<a href=\"" + FoafDomainConstants.PERSON_TYPE + "\">" + FoafDomainConstants.PERSON_LOCALNAME + "</a>" + "}" +
            ", with respective resource shapes {" + "<a href=\"" + "../services/" + OslcConstants.PATH_RESOURCE_SHAPES + "/" + FoafDomainConstants.PERSON_PATH + "\">" + FoafDomainConstants.PERSON_LOCALNAME + "</a>" + "}",
        responses = { 
                                                     ...
                                                     @QueryParam("oslc.pageSize") final String pageSizeString) throws IOException, ServletException
    {
        ...
        List<Person> resources = delegate.queryPersons(httpServletRequest, where, prefix, paging, page, pageSize);
    ...
    public void queryPersonsAsHtml(
                                       ...
                                       @QueryParam("oslc.pageSize") final String pageSizeString) throws ServletException, IOException
    {
        ...
        if ((OSLC4JUtils.hasLyoStorePagingPreciseLimit() && resources.size() >= pageSize) 
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/danielpindur/oslc/jira/personscollection.jsp");
    ...
    @OslcDialog
    (
         title = "SelectorPerson",
         label = "SelectorPerson",
         uri = "service2/persons/selectorPerson",
         hintWidth = "250px",
         hintHeight = "250px",
         resourceTypes = {FoafDomainConstants.PERSON_TYPE},
         usages = {}
    ...
    public Response PersonSelector(
        @QueryParam("terms") final String terms
        
        ) throws ServletException, IOException, JSONException
    {
        // Start of user code PersonSelector_init
        // End of user code
        ...
        // Start of user code PersonSelector_setAttributes
        // End of user code

        if (terms != null ) {
            httpServletRequest.setAttribute("terms", terms);
            final List<Person> resources = delegate.PersonSelector(httpServletRequest, terms);
            if (resources!= null) {
                ...
                for (Person resource : resources) {
                    ...
                    // Start of user code PersonSelector_setResponse
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/danielpindur/oslc/jira/personselector.jsp");
            rd.forward(httpServletRequest, httpServletResponse);
            return null;
        }
    }
